...
const ChatWithCounselor = () => {
  ...
  const [message, setMessage] = useState("");
  const messagesEndRef = useRef(null);
  const deleteTimerRef = useRef(null); // 🧠 Track delete timer
  ...
  const handleSend = () => {
    ...
    setMessage("");
    resetDeleteTimer(); // Start countdown on message send
    ...
    setTimeout(() => {
      ...
      resetDeleteTimer(); // Start countdown on bot reply too
    }, 1500);
  };
